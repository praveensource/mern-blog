      ...
      '>
        <form className='flex flex-col gap-8' onSubmit={handleSubmit}>
            ...
            <div className='flex items-center gap-2'>
                ...
                <Button type='submit' outline className='bg-gradient-to-r from-purple-500 to-pink-500 text-white font-semibold py-2 px-4 rounded-lg shadow-md hover:shadow-lg transition duration-300 ease-in-out'>
                    Apply filters
                </Button>
        </form>
      </div>
