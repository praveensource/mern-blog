...
//   editorClassName="editorClassName min-h-[200px] p-2 focus:outline-none dark:bg-white dark:text-black font-size:1.05erm" onChange={(value) =>{
...
export default function CreatePost() {
  ...
  const handleUploadImage = async () => {
    try {
      ...
      const data = new FormData();
      data.append("file", file);
      data.append("upload_preset", "react_profile_upload"); // your Cloudinary preset
      data.append("cloud_name", import.meta.env.VITE_CLOUDINARY_CLOUD_NAME);
  ...
  const handleSubmit = async (e) => {
    ...
    // Convert EditorState → HTML string
    const rawContent = convertToRaw(editorState.getCurrentContent());
    const htmlContent = draftToHtml(rawContent);

    const postData = { ...formData, content: htmlContent };
