      ...
      <Modal show={showModal} onClose={()=>setShowModal(false)} popup size='md'>
              ...
              <ModalBody>
                <div className="text-center">
                  ...
                  <h3 className='mb-5 text-lg text-gray-500 dark:text-gray-400'>Are you sure your want to delete this post?</h3>
      
                  {/* yes and no */}
                  <div className='flex justify-center gap-4'>
                    <Button className='bg-red-500' outline onClick={handleDeletePost}>Yes i'm sure</Button>
